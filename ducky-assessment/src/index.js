...
program.command('start').description('Begin tracking AI usage in the current directory').action(handleStart);
program.command('stop').description('Stop tracking and write ducky-report.json').action(handleStop);
program.command('status').description('Show whether tracking is active').action(handleStatus);
program.command('live').description('Real-time dashboard - keep running in a separate terminal to watch activity live').action(handleLive);
